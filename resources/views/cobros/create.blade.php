        ...
        <header class="border-b border-slate-200/80 bg-white/85 backdrop-blur-xl">
            <div class="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
                ...
                <div class="flex gap-3 items-center">
                    <button type="button" data-theme-toggle-local class="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200">
                        Modo oscuro
                    </button>
...
<script>
    (() => {
        ...
        const localToggle = document.querySelector('[data-theme-toggle-local]');
        if (globalToggle && localToggle) {
            globalToggle.classList.add('hidden');
            localToggle.addEventListener('click', () => globalToggle.click());
        }
        render();
    })();
</script>
